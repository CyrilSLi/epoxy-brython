...
XMLHttpRequest = class extends EventTarget {
    ...
    #aborted;
    #res; //response object used by Brython
    ...
    send(body) {
        ...
        try {
            queuedFetch(this.#req_url, this.#req_options, (res) => {
                this.#response = res;
